...
<body>
	<div class="well">
		<h1 style="color:#34495E; font-family:times new roman,sans serif; text-align:center; margin-top:40px; font-size:40px;">Welcome To Kailash</h1><br>
    </div>    
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"  method="GET">
	...
	<input type="submit" style="background-color:#273746; color:white; box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); margin-left:75px; padding:5px 10px;">
        ...
        $sql='select * from pg where locality="Kailash"';
